...
// Importing the avatar image from the same folder
import avatarPic from './ava.png';
...
const Navbar = () => {
    ...
    const logoutHandler = async () => {
        try {
            const res = await axios.get('https://backendgmail-dcut.onrender.com/api/v1/user/logout', { withCredentials: true });
            console.log(res);
                ...
                user && (
                    <>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <Avatar src={avatarPic} size="40" round={true} />
                        </div>
                    </>
                )
            }
